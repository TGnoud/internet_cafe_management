...
public class DichVuServiceImpl implements DichVuService {
    ...
    public DichVuDTO addDichVu(DichVuDTO dichVuDTO) {
        ...
        } else if (!dichVu.getTrangThaiDichVu().equalsIgnoreCase("Còn hàng") && !dichVu.getTrangThaiDichVu().equalsIgnoreCase("Hết hàng")) {
            throw new BadRequestException("Trạng thái dịch vụ không hợp lệ. Chỉ chấp nhận 'Còn hàng' hoặc 'Hết hàng'.");
        }
    ...
    public DichVuDTO updateDichVu(String maDV, DichVuDTO dichVuDTO) {
        ...
        if (dichVuDTO.getTrangThaiDichVu() != null && !dichVuDTO.getTrangThaiDichVu().isEmpty()){
            if (!dichVuDTO.getTrangThaiDichVu().equalsIgnoreCase("Còn hàng") && !dichVuDTO.getTrangThaiDichVu().equalsIgnoreCase("Hết hàng")) {
                throw new BadRequestException("Trạng thái dịch vụ không hợp lệ. Chỉ chấp nhận 'Còn hàng' hoặc 'Hết hàng'.");
            }
